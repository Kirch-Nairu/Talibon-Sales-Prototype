    ...
    return <AppLayout title="Home">
        <div className="mx-auto max-w-[1480px] space-y-3">
            ...
            <div className="@container min-w-0 space-y-3">
                ...
                <div className="grid min-w-0 gap-3 xl:grid-cols-[minmax(0,.9fr)_minmax(0,1.1fr)] xl:items-start">
                ...
                <section aria-labelledby="dashboard-operating-picture" className="space-y-3">
                    <div className="flex flex-wrap items-end justify-between gap-2 px-1">
                        <div>
                            <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-blue-700 dark:text-blue-300">Current operating picture</div>
                            <h2 id="dashboard-operating-picture" className="mt-0.5 text-base font-bold text-slate-950 dark:text-slate-100">Workload, office state, and delivery</h2>
                        </div>
                        <p className="max-w-2xl text-xs leading-4 text-slate-500 dark:text-slate-400">Current context is grouped here after immediate work and schedule instead of being split into another full-height conceptual band.</p>
                    </div>
                ...
                <details className="group municipal-panel overflow-hidden">
                    <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 marker:hidden sm:px-5">
                        <div>
                            <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">Reference and history</div>
                            <div className="mt-0.5 text-sm font-bold text-slate-950 dark:text-slate-100">Recent records, correspondence, announcements, and activity</div>
                        </div>
                        <span className="shrink-0 text-xs font-semibold text-blue-700 group-open:hidden dark:text-blue-300">Show context</span>
                        <span className="hidden shrink-0 text-xs font-semibold text-blue-700 group-open:inline dark:text-blue-300">Hide context</span>
                    </summary>
                    <div className="space-y-3 border-t border-slate-200 p-3 dark:border-slate-700 sm:p-4">
                        <div className="grid min-w-0 gap-3 xl:grid-cols-2">
