...
export default function DashboardHeader({ experience }: { experience: DashboardExperience }) {
    ...
    return <header className="municipal-panel overflow-hidden" aria-labelledby="dashboard-title">
        <div className="grid min-w-0 gap-3 px-4 py-3 sm:px-5 @min-[900px]:grid-cols-[minmax(0,1fr)_auto] @min-[900px]:items-center">
            ...
            <div className="flex min-w-0 flex-wrap gap-x-4 gap-y-2 text-xs text-slate-500 dark:text-slate-400 @min-[900px]:max-w-[520px] @min-[900px]:justify-end">
