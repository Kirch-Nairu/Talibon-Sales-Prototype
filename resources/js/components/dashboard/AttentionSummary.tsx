...
export default function AttentionSummary({
    ...
    return <section className="municipal-panel overflow-hidden" aria-labelledby="dashboard-attention-summary">
        <div className="border-b border-slate-200 px-4 py-3 dark:border-slate-700 sm:px-5">
            <h2 id="dashboard-attention-summary" className="text-sm font-bold text-slate-950 dark:text-slate-100 sm:text-base">Attention today</h2>
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Counts are derived from the work, project, deadline, and correspondence records shown on this Home view.</p>
        </div>
