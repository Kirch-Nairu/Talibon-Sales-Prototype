    ...
    return (
        <div ref={panel} className="relative hidden md:block">
            <button
                ...
                className={`flex h-10 items-center gap-2 rounded-lg px-2.5 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-blue-700/30 ${open ? 'bg-blue-50 text-blue-800 dark:bg-blue-950/45 dark:text-blue-200' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800'}`}
