...
export default function PortalHeaderIdentity({ user }: { user: AuthUser | null }) {
    ...
    return (
        <div aria-label={`Signed in as ${user.name}`} className="flex min-w-0 items-center gap-2.5 border-l border-slate-200 pl-3 dark:border-slate-700">
            <span
            ...
            <div className="hidden min-w-0 max-w-44 xl:block">
                ...
                {office && <div className="truncate text-xs text-slate-500 dark:text-slate-400">{office}</div>}
